      ...
      <div className="flex flex-col justify-center items-center md:flex-row">
        <div className="flex-[6] flex flex-col justify-center items-center lg:justify-start lg:items-start">
          ...
          <p className="font-secondry text-white pt-5 pb-5 md:text-lg">
            Hello, my name is Leen Al Harash. I’m a developer with a passion
            for
            <a
            ...
            A passionate application developer ; web & mobile, with an interest in both front-end and back-end technologies. Proficient in customer service and able to work with minimal 
            to no supervision. Enhanced communication and leadership, ability to lead teams and manage projects at various levels. I'm always open to sharing insights, and 
